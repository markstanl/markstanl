...
![Generated Image](http://147.182.254.93:8000/generate-image?timestamp=<current_timestamp>&theme=merko)

<img id="dynamic-image" src="" />

<script>
  const img = document.getElementById('dynamic-image');
  img.src = `http://147.182.254.93:8000/generate-image?theme=merko&timestamp=${new Date().getTime()}`;
</script>
